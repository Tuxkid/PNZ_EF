plot.reportA <- function(titl = FALSE, span = .8 )
{
### Purpose:- "New" ALCM species
### ----------------------------------------------------------------------
### Modified from:- plot.report and plot.presentationA
### ----------------------------------------------------------------------
### Arguments:- 
### ----------------------------------------------------------------------
### Author:-   Patrick Connolly, Date:- 17 Jun 2013, 12:29
### ----------------------------------------------------------------------
### Revisions:- 
...
### plotting begins
  bitmap("ALMCml_R.png", type = "png16m", width = 155, height = 143,
...
### plotting begins
  bitmap("ALMCmd_R.png", type = "png16m", width = 155, height = 143,
         res = 900, units = "mm", pointsize = 11)
  with(alcm.df, blank.plot(Efppm, AngMort, ylim = c(0, 90)))
  axis(1, las = 1, mgp = c(1.8, .8, 0), cex.axis = .8)
  axis(2, las = 1, at = ytix.at, labels = ytix,
