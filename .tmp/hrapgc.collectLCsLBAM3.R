collectLCsLBAM3 <- function(xO = septLBAMoffCI.df, xOCT = septLBAMoffCI_CT.df,
...
{
### Purpose:- Adjusts intercept instead of slope
### ----------------------------------------------------------------------
### Modified from:- collectLCsLBAM2
### ----------------------------------------------------------------------
### Arguments:- 
### ----------------------------------------------------------------------
### Author:-   Patrick Connolly, Date:- 25 Sep 2015, 15:41
### ----------------------------------------------------------------------
### Revisions:- 
