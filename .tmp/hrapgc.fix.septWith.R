fix.septWith <- function(xx = sept15With.df, rm.codling = TRUE)
{
### Purpose:- Generalise to all species
### ----------------------------------------------------------------------
### Modified from:- septLBAMwith
### ----------------------------------------------------------------------
### Arguments:- rm.codling: remove codling data (it's unusable)
### ----------------------------------------------------------------------
### Author:-   Patrick Connolly, Date:- 30 Sep 2015, 14:20
### ----------------------------------------------------------------------
### Revisions:- 
...
##   xx <- within(xx, UC <- unclass(Efnom))
  ...
  xx <- within(xx, SLS <- as.factor(SLS))
